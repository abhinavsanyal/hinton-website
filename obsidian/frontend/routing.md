...
|-------|------|------|--------|
| `/` | `src/app/page.tsx` | `views/home.tsx` → `HomeView` | Dynamic |
| `/work` | `src/app/work/page.tsx` | `views/work/work-view.tsx` → `WorkView` | Dynamic (reads `public/assets/all-content` at request time) |
| `/services` | `src/app/services/page.tsx` | `views/services/services-index-view.tsx` | Static |
| `/services/[slug]` | `src/app/services/[slug]/page.tsx` | `views/services/service-view.tsx` | SSG × 5, `dynamicParams = false` |

The service routes derive their params, metadata, JSON-LD and sitemap entries
from `data/mocks/services.ts` — see [[service-pages]].
