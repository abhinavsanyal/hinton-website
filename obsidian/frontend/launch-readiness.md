...
2. In GA4, review Realtime/DebugView, mark `generate_lead` as a key event, link Google Ads and exclude local/test traffic. Manual SPA page views are implemented; disable duplicate history-based page views or duplicate GTM installations in account configuration.
