...
EDL = [
    ...
    ("only_now", 36.22, 37.18, 53.55), ("the_camera", 37.18, 38.09, 54.75), ("imagination", 38.09, 39.269, 55.85),
    ("heres_to", 39.819, 42.15, 58.90), ("impossible", 42.15, 43.86, 61.45), ("made_india", 44.31, 45.491, 64.10),
    ("for_world", 45.791, 46.758, 65.75), ("hinton", 47.458, 48.78, 68.00), ("dream4k", 48.78, 50.56, 69.40),
    ("create_ai", 50.56, 52.471, 71.60), ("visionaries", 53.271, 56.8, 74.60), ("are_you", 56.8, 58.071, 79.00),
]
TOTAL = 90.0
